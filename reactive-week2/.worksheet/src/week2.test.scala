...
object test {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(72); 
  ...
  val in1, in2, sum, carry = new Wire;System.out.println("""in1  : week2.test.sim.Wire = """ + $show(in1 ));System.out.println("""in2  : week2.test.sim.Wire = """ + $show(in2 ));System.out.println("""sum  : week2.test.sim.Wire = """ + $show(sum ));System.out.println("""carry  : week2.test.sim.Wire = """ + $show(carry ));$skip(35); 
